        ...
        <CardContent className="relative z-10">
          <div className="space-y-4">
            ...
            <input
              ...
              disabled
              className="w-full px-4 py-2 rounded-lg bg-secondary/30 border border-border/30 text-muted-foreground placeholder-muted-foreground/50 cursor-not-allowed opacity-60"
            />
            ...
            <div className="flex gap-3 justify-center">
              <Button
                disabled
                className="flex-1 bg-secondary/50 text-muted-foreground py-6 rounded-lg cursor-not-allowed"
              >
